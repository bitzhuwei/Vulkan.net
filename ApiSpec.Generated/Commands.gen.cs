...
using VkMemoryRequirements2KHR = ApiSpec.Generated.VkMemoryRequirements2;
...
using VkAttachmentDescriptionFlags = ApiSpec.Generated.VkAttachmentDescriptionFlagBits;
using VkBufferCreateFlags = ApiSpec.Generated.VkBufferCreateFlagBits;
using VkBufferUsageFlags = ApiSpec.Generated.VkBufferUsageFlagBits;
// VkBufferViewCreateFlags - Reserved for future use
using VkBuildAccelerationStructureFlagsNV = ApiSpec.Generated.VkBuildAccelerationStructureFlagBitsNV;
using VkColorComponentFlags = ApiSpec.Generated.VkColorComponentFlagBits;
using VkCommandBufferUsageFlags = ApiSpec.Generated.VkCommandBufferUsageFlagBits;
using VkCommandPoolCreateFlags = ApiSpec.Generated.VkCommandPoolCreateFlagBits;
// VkCommandPoolTrimFlags - Reserved for future use
using VkCompositeAlphaFlagsKHR = ApiSpec.Generated.VkCompositeAlphaFlagBitsKHR;
using VkConditionalRenderingFlagsEXT = ApiSpec.Generated.VkConditionalRenderingFlagBitsEXT;
using VkCullModeFlags = ApiSpec.Generated.VkCullModeFlagBits;
using VkDebugReportFlagsEXT = ApiSpec.Generated.VkDebugReportFlagBitsEXT;
using VkDebugUtilsMessageSeverityFlagsEXT = ApiSpec.Generated.VkDebugUtilsMessageSeverityFlagBitsEXT;
using VkDebugUtilsMessageTypeFlagsEXT = ApiSpec.Generated.VkDebugUtilsMessageTypeFlagBitsEXT;
using VkDependencyFlags = ApiSpec.Generated.VkDependencyFlagBits;
using VkDescriptorBindingFlagsEXT = ApiSpec.Generated.VkDescriptorBindingFlagBitsEXT;
using VkDescriptorPoolCreateFlags = ApiSpec.Generated.VkDescriptorPoolCreateFlagBits;
// VkDescriptorPoolResetFlags - Reserved for future use
using VkDescriptorSetLayoutCreateFlags = ApiSpec.Generated.VkDescriptorSetLayoutCreateFlagBits;
// VkDescriptorUpdateTemplateCreateFlags - Reserved for future use
// VkDeviceCreateFlags - Reserved for future use
using VkDeviceGroupPresentModeFlagsKHR = ApiSpec.Generated.VkDeviceGroupPresentModeFlagBitsKHR;
using VkDeviceQueueCreateFlags = ApiSpec.Generated.VkDeviceQueueCreateFlagBits;
using VkDisplayPlaneAlphaFlagsKHR = ApiSpec.Generated.VkDisplayPlaneAlphaFlagBitsKHR;
// VkEventCreateFlags - Reserved for future use
using VkExternalFenceFeatureFlags = ApiSpec.Generated.VkExternalFenceFeatureFlagBits;
using VkExternalFenceHandleTypeFlags = ApiSpec.Generated.VkExternalFenceHandleTypeFlagBits;
using VkExternalMemoryFeatureFlags = ApiSpec.Generated.VkExternalMemoryFeatureFlagBits;
using VkExternalMemoryFeatureFlagsNV = ApiSpec.Generated.VkExternalMemoryFeatureFlagBitsNV;
using VkExternalMemoryHandleTypeFlags = ApiSpec.Generated.VkExternalMemoryHandleTypeFlagBits;
using VkExternalMemoryHandleTypeFlagsNV = ApiSpec.Generated.VkExternalMemoryHandleTypeFlagBitsNV;
using VkExternalSemaphoreFeatureFlags = ApiSpec.Generated.VkExternalSemaphoreFeatureFlagBits;
using VkExternalSemaphoreHandleTypeFlags = ApiSpec.Generated.VkExternalSemaphoreHandleTypeFlagBits;
using VkFenceCreateFlags = ApiSpec.Generated.VkFenceCreateFlagBits;
using VkFenceImportFlags = ApiSpec.Generated.VkFenceImportFlagBits;
using VkFormatFeatureFlags = ApiSpec.Generated.VkFormatFeatureFlagBits;
// VkFramebufferCreateFlags - Reserved for future use
using VkGeometryFlagsNV = ApiSpec.Generated.VkGeometryFlagBitsNV;
using VkImageAspectFlags = ApiSpec.Generated.VkImageAspectFlagBits;
using VkImageCreateFlags = ApiSpec.Generated.VkImageCreateFlagBits;
using VkImageUsageFlags = ApiSpec.Generated.VkImageUsageFlagBits;
// VkImageViewCreateFlags - Reserved for future use
using VkIndirectCommandsLayoutUsageFlagsNVX = ApiSpec.Generated.VkIndirectCommandsLayoutUsageFlagBitsNVX;
// VkInstanceCreateFlags - Reserved for future use
using VkMemoryAllocateFlags = ApiSpec.Generated.VkMemoryAllocateFlagBits;
using VkMemoryHeapFlags = ApiSpec.Generated.VkMemoryHeapFlagBits;
// VkMemoryMapFlags - Reserved for future use
using VkMemoryPropertyFlags = ApiSpec.Generated.VkMemoryPropertyFlagBits;
using VkObjectEntryUsageFlagsNVX = ApiSpec.Generated.VkObjectEntryUsageFlagBitsNVX;
...
using VkPipelineCreateFlags = ApiSpec.Generated.VkPipelineCreateFlagBits;
using VkPipelineCreationFeedbackFlagsEXT = ApiSpec.Generated.VkPipelineCreationFeedbackFlagBitsEXT;
...
using VkPipelineStageFlags = ApiSpec.Generated.VkPipelineStageFlagBits;
...
using VkQueryControlFlags = ApiSpec.Generated.VkQueryControlFlagBits;
using VkQueryPipelineStatisticFlags = ApiSpec.Generated.VkQueryPipelineStatisticFlagBits;
// VkQueryPoolCreateFlags - Reserved for future use
using VkQueueFlags = ApiSpec.Generated.VkQueueFlagBits;
// VkRenderPassCreateFlags - Reserved for future use
using VkResolveModeFlagsKHR = ApiSpec.Generated.VkResolveModeFlagBitsKHR;
using VkSampleCountFlags = ApiSpec.Generated.VkSampleCountFlagBits;
// VkSamplerCreateFlags - Reserved for future use
// VkSemaphoreCreateFlags - Reserved for future use
using VkSemaphoreImportFlags = ApiSpec.Generated.VkSemaphoreImportFlagBits;
// VkShaderModuleCreateFlags - Reserved for future use
using VkShaderStageFlags = ApiSpec.Generated.VkShaderStageFlagBits;
using VkSparseImageFormatFlags = ApiSpec.Generated.VkSparseImageFormatFlagBits;
using VkSparseMemoryBindFlags = ApiSpec.Generated.VkSparseMemoryBindFlagBits;
using VkSubgroupFeatureFlags = ApiSpec.Generated.VkSubgroupFeatureFlagBits;
using VkSubpassDescriptionFlags = ApiSpec.Generated.VkSubpassDescriptionFlagBits;
